...
public class SistemaDeCircuitoDeTv {

    // Variáveis
    private String nome = "Sistema de Circuito de Tv";
    ...
    private int imagem = (R.drawable.circuito_tv);
    ...
    public Boolean Exigencia (int grupo, int divisao, int area, int altura,int lotacao,int pavimentos, int tunel, int liquidos, int produtos, int plataforma){
        ...
        switch (grupo) {
            ...
            case R.id.bt_N:
                ...
                break;
            case R.id.bt_M:
                tem = divisao == R.id.M1 && tunel == R.id.tunel4;
                break;
        }
